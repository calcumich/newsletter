...
from newsletter.gmail import ensure_dependencies as gmail_ensure_dependencies
...
def ensure_dependencies():
    gmail_ensure_dependencies(BeautifulSoup is not None)
...
def ingest(
    ...
    service = get_gmail_service(
        credentials_path,
        token_path,
        beautiful_soup_available=BeautifulSoup is not None,
    )
